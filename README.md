...
**Setup guides:** [connect Claude Code / Codex to the MCP server](docs/guides/mcp-hosts.md) · [use LM Studio as a zero-key local provider](docs/guides/lm-studio.md) · [configure the GraphRAG provider](docs/guides/graphrag-provider.md)
